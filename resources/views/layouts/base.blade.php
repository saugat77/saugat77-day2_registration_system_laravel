...
<header>
 <div class="right-bar-top">  
        <ul class="nav justify-content-end">
            <li class="nav-item">
                <a class="nav-link active" style="color:orange " aria-current="page" href="#" >Translation Site   <span>|</span></a>
            </li>
            <li class="nav-item">
...
<div class="hidden top-0 right-0 px-6 py-4 sm:block">
    @auth
        ...
        <div class="nav-bar-down" >
            ...
            <b>  <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">{{Auth::user()->name}}</a></b>
            </button>
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item" href="{{ url('logout')}}">Logout</li>
...
<div class="nav-bar-down" >
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="margin-left:30px;background-color:white; color:black">
    <b> Get Involved</b>
    </button>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        <li><a class="dropdown-item" href="#">Action</a></li>
  ...
  <button class="btn btn-secondary " style="margin-left:30px; background-color:white; color:black">
   <b>Events</b>
  </button>
  <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="margin-left:30px; background-color:white; color:black">
   <b>About Us</b>
  ...
  <button type="submit" style="margin-left:30px; background-color:red; color:white" >DONATE</button>
